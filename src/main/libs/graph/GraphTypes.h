...
//
#ifndef SAMPLE_GRAPHTYPES_H
#define SAMPLE_GRAPHTYPES_H
...
/**********WAY 2 (using adjacency  list)**********************/
    ...
    AdjList.assign(V,
                   vii()); // quick way to initialize AdjList with V entries of vii(constructor of empty vactors) using assign(n,value);
