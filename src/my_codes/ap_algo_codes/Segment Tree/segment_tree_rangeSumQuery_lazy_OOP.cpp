...
public:
    ...
    int getSum(int start,int end){
        ...
        //we have to calculate the sum
            return getSumUtil(0,A.size()-1,start,end,1);
    }
    ...
    int updateRange(int updateIndexStart,int updateIndexEnd,int value)
    {

            //we have to update value and also update the nodes affected by it
            updateRangeUtil(0,A.size()-1,updateIndexStart,updateIndexEnd,value,1);
